...
def create_model(loadweight=None):
    ##### MODEL #####
    sequence_input = Input(shape=(no_sentences_per_doc, sentence_embedding), dtype='float32')
    ...
    preds = Dense(1, activation='sigmoid',name='output')(sent_drop)  # NOTE: SIGMOID FOR 2-CLASS PROBLEM; softmax for multiclass problem
...
Careful:
    ...
    Hence, for Fscore calculaton the y_test must be trimmed!
