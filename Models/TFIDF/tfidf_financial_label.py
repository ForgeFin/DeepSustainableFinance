...
batch = 32
denser = 100
regu = 0.01 ## fittet nicht mit regu, keine regu verwenden
drop = 0.5
...
sparse_x = t.texts_to_matrix(doc_training, mode='tfidf')
sparse_x_val = t.texts_to_matrix(doc_val, mode='tfidf')
sparse_x_test = t.texts_to_matrix(doc_test, mode='tfidf')
...
def create_model(loadweight=None):
    ...
    x = Dense(denser,# kernel_regularizer=l1(0.0001),
              ...
              )(sequence_input) # activity_regularizer = on outout of the layer 
    x = Dropout(0.5)(x)
...
def predict_prob(string):
    ...
    '''
    global model
    x_temp = t.texts_to_matrix(string, mode='tfidf')
...
one_doc_sparse = t.texts_to_matrix(one_doc, mode='tfidf')
...
zero_doc_sparse = t.texts_to_matrix(zero_doc, mode='tfidf')
...
both_doc_sparse = t.texts_to_matrix(both_doc, mode='tfidf')
