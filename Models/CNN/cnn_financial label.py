...
## define folder for saving cnn models
savemodel = 'C:/Users/.../saved_models/cnn/'
...
print("loss",loss)
print("")
print("fscore val",f1_sc_val)
print("loss val",val_loss)
print("Best Val model",best_val_index)
...
## test of predict prob, works
# test_string = doc_val[0:3]
# tt = predict_prob(test_string)

# x_temp = t.texts_to_matrix(test_string, mode='tfidf')
# x_temp = x_temp.astype('float32')

# temp = x_temp[1]  # test for different indices
